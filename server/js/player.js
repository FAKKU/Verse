    ...
    init: function(connection, worldServer, databaseHandler) {
        ...
        this.connection.listen(function(message) {
            ...
            if(action === Types.Messages.CREATE || action === Types.Messages.LOGIN) {
                ...
                databaseHandler.checkUserExists(self.name, function(userExists) {
                    if(userExists === false && action === Types.Messages.CREATE) {
                ...
                if (mob) {
                    ...
                    if(dmg > 0) {
                      if(mob.type !== "player"){
                        ...
                        mob.hitPoints -= dmg;
                        if(mob.server && mob.server.handleHurtEntity) {
