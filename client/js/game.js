...
function(InfoManager, BubbleManager, Renderer, Map, Animation, Sprite, AnimatedTile,
    ...
    var Game = Class.extend({
        ...
        makeNpcTalk: function(npc) {
            ...
            if(npc) {
                msg = npc.talk(this);
                npcName = npc.getName(this);
                this.previousClickPosition = {};
                if(msg) {
                    this.createBubble(npc.id, msg, npcName);
       ...
       getNpcAt: function(x, y) {
        ...
        createBubble: function(id, message, npcName) {
            this.bubbleManager.create(id, message, this.currentTime, npcName);
        },
