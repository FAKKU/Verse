...
define(['jquery', 'animation', 'sprites'], function($, Animation, sprites) {
    ...
    var Sprite = Class.extend({
        ...
        loadJSON: function(data) {
            ...
            this.atkSpeed = (data.atkSpeed !== undefined) ? data.atkSpeed : 50;
            this.idleSpeed = (data.idleSpeed !== undefined) ? data.idleSpeed : 450;
            this.moveSpeed = (data.moveSpeed !== undefined) ? data.moveSpeed : 120;
            this.walkSpeed = (data.walkSpeed !== undefined) ? data.walkSpeed : 450;
            this.load();
        },
